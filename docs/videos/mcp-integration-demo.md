---
title: "Video: MCP Integration Demo"
description: Video demonstration of connecting AI assistants to TI Mindmap HUB via the Model Context Protocol.
---
...
- **STIX retrieval** — Fetching structured bundles through conversation
- **Weekly briefings** — Getting the latest threat landscape summary

---

## Related

- [MCP Server Documentation](../integrations/mcp/index.md)
- [VS Code + Copilot Setup](../integrations/mcp/vscode-copilot.md)
- [Claude Desktop Setup](../integrations/mcp/claude-desktop.md)
